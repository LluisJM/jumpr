...
execute as @e[type=creeper] run function jumpr:game/start_next_phase/nested_execute_5
execute as @e[type=shulker] run function jumpr:game/start_next_phase/nested_execute_6
title @a actionbar ""
